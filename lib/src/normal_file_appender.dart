...
final _logger = DummyLogger('logging_appenders.normal_file_appender');

class NormalFileAppender extends BaseLogAppender {
  NormalFileAppender({
  ...
  Future<void> _checkFile({String ext = '.log'}) async {
